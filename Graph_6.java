...
public static void dfs(ArrayList<edge1> graph[], int curr, int par, 
...
public static void getAP(ArrayList<edge1> graph[], int V){
    ...
    int time = 0;
    boolean vis[] = new boolean[V];
//Sometimes articulation point value starts repeating itslef in case of large graph so for that we have this
